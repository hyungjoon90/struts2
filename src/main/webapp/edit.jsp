  ...
  <!-- menu end -->
	<div class="row content">
	  <div class="col-md-12">
		...
		<form class="form-horizontal" action="update.bit">
		  <div class="form-group">
		    <label for="sabun" class="col-sm-2 control-label">sabun</label>
		    <div class="col-sm-10">
		    	${bean.sabun }<input value="${bean.sabun }" type="hidden" name="sabun" class="form-control" id="sabun" placeholder="sabun">
		    </div>
		  </div>
		   <div class="form-group">
		    <label for="name" class="col-sm-2 control-label">name</label>
		    <div class="col-sm-10">
		    	<input type="text" name="name" class="form-control" id="name" placeholder="name" value="${bean.name }">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		    	<input type="text" name="pay" class="form-control" id="pay" placeholder="pay" value="${bean.pay }">
		    </div>
		  </div>
		  <div class="form-group">
